...
export REF="/ifs/data/c2b2/ngs_lab/ngs/resources/bwa_samtools_gatk_DB/hg19.fasta"
...
export PICARD="/ifs/home/c2b2/ngs_lab/ngs/data/Pipeline/picard-tools-1.92"
# export BWA="/ifs/data/c2b2/ngs_lab/ngs/usr/bin/bwa"  
## use bwa mem 
export BWA="/ifs/data/c2b2/ngs_lab/ngs/usr/bwa_github/bwa"
